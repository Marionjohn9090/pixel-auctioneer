...
<div class="container-fluid">
	...
	<p>Art Category: <b><?php echo $category ?></b></p>
		...
		<div class="col-md-12">
			<form id="manage-bid">
				...
				<div class="form-group">
					<label for="" class="control-label">Bid Amount (Ksh)</label>
...
<script>
	...
	$('#participate').click(function(){
        _conf("Are you sure you want to participate in this event?","participate",[<?php echo $id ?>],'mid-large')
    })
