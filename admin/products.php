						...
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								...
								<tr data-id= '<?php echo $row['id'] ?>'>
									...
									<td>
										 <p><small>Regular Price (Ksh): <b><?php echo number_format($row['regular_price'],2) ?></b></small></p>
										 <p><small>Start Price (Ksh): <b><?php echo number_format($row['start_bid'],2) ?></b></small></p>
